    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if($main_menu == 'Users') active @endif">
                ...
                <div id="collapseUsers" class="collapse @if($main_menu == 'Users') show @endif" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            ...
            <li class="nav-item @if($main_menu == 'Products') active @endif">
                ...
                <div id="collapseProducts" class="collapse @if($main_menu == 'Products') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Components:</h6>
            ...
            <li class="nav-item @if($main_menu == 'Reports') active @endif">
                ...
                <div id="collapseReports" class="collapse @if($main_menu == 'Reports') show @endif" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Components:</h6>
                        <a class="collapse-item @if($sub_menu == 'day_reports') active @endif" href="{{route('reports.day_reports')}}">Day Reports</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; POS {{date('Y')}}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
