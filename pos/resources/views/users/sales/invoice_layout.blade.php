...
<div class="row clearfix page-header">
  <div class="col-md-2">
      <a class="btn btn-info" href="{{ route ('users.sales.invoices', ['id'=>$user->id])}}"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back </a>
  </div>
...
<div class="row clearfix mt-5">
    <div class="col-md-2">
        <div class="nav flex-column nav-pills">
          ...
          <a class="nav-link @if($tab_menu == 'sales') active @endif" href="{{route ('users.sales.invoices.items', ['id' => $user->id, 'invoice_id'=>$invoice->id])}}">Sale Items</a>
